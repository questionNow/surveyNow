...
//out.println("<script>alert('loginType : " + loginType + "');</script>");
	...
	$(function(){
		$(".list-table td").mouseenter(function(){
			...
			<%if (loginType.equals("Y")) {%>  
				...
				location.href="<%=request.getContextPath()%>/detail.bo?bnum=" + bnum+"&loginType="+loginType;
