...
<%-- <%if(loginUser != null) {%>
	...
	<div class="nav nav-sky" align="center">
		...
		<div class="nav-elements">
			<ul class="nav-content">
				...
				<li>
					...
					<a href="#" class="dropdown-link">설문관리<i class="fas fa-caret-down"></i> </a>
						<div class="dropdown-menu">
							...
							<a onclick="deleteSurvey();" href="#"> 삭제된 설문 </a> 
				...
				<li><a onclick="qnaList();"> 고객센터 </a></li>
			</ul>
		</div>
	...
	<script>
    	...
    	function completeSurvey(){
    		location.href = "<%=request.getContextPath()%>/adminComplete.sv";	
    		/* CompleteSurveyServlet ㄱㄱ*/ 
    	}
    	
    	
    	function holdSurvey(){
    		location.href = "<%=request.getContextPath()%>/adminHold.sv";
    		/*PaySurveyServlet ㄱㄱ*/
    	}
    	
    	function proceedSurvey(){
    		location.href = "<%=request.getContextPath()%>/adminProceed.sv";		
    		/* ProceedSurveyServlet ㄱㄱ */
    	}
    	
    	function deleteSurvey(){
    		location.href = "<%=request.getContextPath()%>/adminDelete.sv";
    	}
