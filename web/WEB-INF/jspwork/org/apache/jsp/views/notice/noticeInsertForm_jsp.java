 ...
 * Generated at: 2019-09-27 08:08:29 UTC
...
public final class noticeInsertForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/notice/../common/menubar.jsp", Long.valueOf(1569493700813L));
  }
...
if(loginUser == null) {
      ...
      out.write("\t\t\t\t\t\t\t<!-- type=\"hidden\" : 화면에는 안보이게 하고싶고 값을 servlet으로 넘겨주고싶을때 사용 -->\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>작성일</td>\r\n");
      ...
      out.write("\t\t\t\t<!-- 사용자가 입력을 잘못 하면 입력 했던 내용을 지워줄 수 있게 reset타입 button버튼 만들자!! -->\r\n");
      out.write("\t\t\t\t\t<button type=\"reset\">취소하기</button> \r\n");
      out.write("\t\t\t\t\t<button type=\"submit\">등록하기</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- InsertNoticeServlet 만들러 꼬꼬쓍~! -->\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
