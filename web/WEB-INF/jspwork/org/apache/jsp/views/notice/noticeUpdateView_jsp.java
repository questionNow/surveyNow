 ...
 * Generated at: 2019-09-30 08:00:17 UTC
...
public final class noticeUpdateView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!-- 20190927  -->\r\n");
      out.write("\r\n");
      out.write("<!-- 이 페이지는  noticeDetatilView.jsp를 복붙해서 readonly로 풀어줘야 될 것들 풀어주고 버튼만 바꿔주자 \r\n");
      out.write("\tform 태그도 여기에는 추가해 주자\r\n");
      out.write("-->\r\n");
      out.write("\r\n");
...
if(loginUser == null) {
      ...
      out.write("\t\t\t<form id=\"updateForm\" method=\"post\">\t<!-- table부터 아래 버튼까지 포함하는 form태그  -->\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>제목</td>\r\n");
      ...
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<!-- servlet에서 이 페이지의 정보중 필요로 하는 것이 있다면 name에 담아서 넘기는데\r\n");
      out.write("\t\t\t\t\t\t화면에 보여줄 필요가 없다면 hidden 타입 input태그에 실어 보내자 -->\r\n");
      ...
      out.write("\t\t\t\t\t<button onclick=\"update()\">수정임</button><!-- 여기는 일종의 submit버튼이 수정하기임 -->\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<button onclick=\"nDelete()\">삭제임</button>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t<script>/* script 태그는 어디에 만들던 상관없수다 */\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t//공지사항 수정하기 작업 먼저해부려\r\n");
      out.write("\t\t\t\tfunction update(){\r\n");
      out.write("\t\t\t\t\t$(\"#updateForm\").attr(\"action\", \"");
      out.print(request.getContextPath());
      out.write("/update.no\");\r\n");
      out.write("\t\t\t\t\t// NoticeUpdateServlet 만들러 ㄱㄱ씽\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t//공지사항 날려부려 \r\n");
      ...
      out.write("\t\t\t\t\t$(\"#updateForm\").attr(\"action\", \"");
      out.print(request.getContextPath());
      out.write("/nDelete.no\");\r\n");
      out.write("\t\t\t\t\t// NoticeDeleteServlet 만들러 ㄱㄱ 씽\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("// 20190927은 여기까지~ 이히힛 불금인데 약속이없다 하핫!\r\n");
      out.write("\t\t\t</script>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
