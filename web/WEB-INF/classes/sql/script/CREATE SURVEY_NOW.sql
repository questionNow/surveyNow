...
CREATE TABLE NOTICE (
     ...
     CONSTRAINT NOTICE_FK FOREIGN KEY(NWRITER) REFERENCES USER_INFO(USERID) ON DELETE CASCADE
);
...
CREATE TABLE REPLY(
     ...
     CONSTRAINT REPLY_CNUM_FK FOREIGN KEY(NNUM) REFERENCES NOTICE(NNUM)  ON DELETE CASCADE,
     CONSTRAINT CREPLY_REPLYID_FK FOREIGN KEY(REPLYID) REFERENCES USER_INFO(USERID)  ON DELETE CASCADE
);
...
CREATE TABLE PRODUCT(
   ...
   PROCOUNT NUMBER(38),
    ...
    CONSTRAINT PRODUCT_FK FOREIGN KEY(CATEGORYID) REFERENCES PRODUCTCATEGORY(CATEGORYID) ON DELETE CASCADE
);
...
CREATE TABLE BUYPRODUCT(
   ...
   BDATE DATE,
    ...
    CONSTRAINT BUYPRODUCT_PRONUM_FK FOREIGN KEY(PRONUM) REFERENCES PRODUCT(PRONUM) ON DELETE CASCADE,
    CONSTRAINT BUYPRODUCT_USERID_FK FOREIGN KEY(BUYID) REFERENCES USER_INFO(USERID) ON DELETE CASCADE
);
