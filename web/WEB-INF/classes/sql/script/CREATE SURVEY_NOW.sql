...
INSERT INTO QUESTION_TYPE VALUES('주관식',NULL);mjm
...
CREATE OR REPLACE VIEW DOSURVEYLIST
AS
SELECT * FROM SURVEY
LEFT JOIN QUESTION USING (SNUM)
LEFT JOIN RESULT USING (QNUM);
