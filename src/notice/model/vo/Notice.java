...
public class Notice implements Serializable{
	...
	public Notice(int nNum, String nWriter, String nwName, String nTitle, String nContent, Date nCreateDate,
			Date nUpdateDate, String nType, String nStatus) {
		super();
		this.nNum = nNum;
	...
	public String toString() {
		return "Notice [nNum=" + nNum + ", nWriter=" + nWriter + ", nwName=" + nwName + ", nTitle=" + nTitle
				+ ", nContent=" + nContent + ", nCreateDate=" + nCreateDate + ", nUpdateDate=" + nUpdateDate
