...
ALTER TABLE QUESTION ADD CONSTRAINT FK_SURVEY_TO_QUESTION FOREIGN KEY(
	REFSNUM
)
REFERENCES SURVEY (
	SNUM
...
ALTER TABLE ANSWER ADD CONSTRAINT FK_QUESTION_TO_ANSWER FOREIGN KEY(
	REFQNUM
)
REFERENCES QUESTION(
	QNUM
