...
public class MainSerachVo implements Serializable{
	...
	public MainSerachVo(String userId, String userPwd, String userName, int age, String gender, String email,
			String phone, String address, String recommendId, int surveyCount, int visitCount, int userType,
			String status, String finalEducation, String job, String income, String livingType, String houseType,
			String religion, String maritalStatus, String livingWith, String armyGo, String interest, Date pwdDate) {
		this.userId = userId;
	...
	public String toString() {
		return "MainSerach [userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName + ", age=" + age
